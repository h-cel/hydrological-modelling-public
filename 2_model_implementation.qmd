...
The forward Euler scheme presented above is the simplest available numerical method to solve the ordinary differential equations. [`SciPy`](https://docs.scipy.org/doc/scipy/index.html) offers more advanced numerical time integration methods. Investigate how the choice of time integration method affects the model outcome.
